...
array index in range [l:r+1]. If you use segment tree then your algorithm complexity will be
O(nlogn)
'''
from pydatastructs.utils import TreeNode
from collections import deque as Queue
from pydatastructs.linear_data_structures.arrays import _check_type
from pydatafrom pydatastructs.trees.binary_trees import (
    BinarySearchTree, BinaryTreeTraversal, AVLTree,
    ArrayForTrees, BinaryIndexedTree, SelfBalancingBinaryTree, SplayTree, CartesianTree, Treap, RedBlackTree)structs.utils.misc_util import TreeNode
