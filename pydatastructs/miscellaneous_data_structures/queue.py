...
class PriorityQueue(Queue):
    ...
    deleteHighestPriority : method()
     - deletes the element with highest priority in the queue
     - priority can be min or max

    getHighestPriority : method()
     - Prints element with Highest Priority in the queue
    '''
    def __new__(cls):
        obj = object.__new__(cls)
        obj.queue =[]
