...
static PyObject* quick_sort(PyObject* self, PyObject* args, PyObject* kwds) {
    ...
    int is_DynamicOneDimensionalArray = PyObject_TypeCheck(args0, &DynamicOneDimensionalArrayType);
    int is_OneDimensionalArray = PyObject_TypeCheck(args0, &OneDimensionalArrayType);
